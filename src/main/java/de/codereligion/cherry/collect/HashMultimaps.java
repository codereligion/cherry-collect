...
public final class HashMultimaps {
     ...
     */
    public static <K, V> HashMultimap<K, V> from(final Iterable<V> iterable, final Function<? super V, K> keyFunction) {
     ...
     * @throws IllegalArgumentException when any of the given parameters are {@code null}
     */
    public static <E, K, V> HashMultimap<K, V> from(final Iterable<E> iterable,
