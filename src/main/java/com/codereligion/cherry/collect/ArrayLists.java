...
public final class ArrayLists {
     ...
     */
    public static <F, T> ArrayList<T> createFrom(final Iterable<F> iterable, final Function<? super F, T> function) {
     ...
     * @throws IllegalArgumentException when any of the given parameters are {@code null}
     */
    public static <E> ArrayList<E> createFrom(final Iterable<E> iterable, final Predicate<? super E> predicate) {
     ...
     * @throws IllegalArgumentException when any of the given parameters are {@code null}
     */
    public static <F, T> ArrayList<T> createFrom(final Iterable<F> iterable, final Predicate<? super F> predicate, final Function<? super F, T> function) {
