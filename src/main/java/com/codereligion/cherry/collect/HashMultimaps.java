...
/**
 * Factory class for {@link com.google.common.collect.HashMultimap HashMultimaps}.
 *
 * @author Sebastian Gr&oml;bler
 * @since 28.12.2014
 */
public final class HashMultimaps {

    private HashMultimaps() {
     ...
     */
    public static <K, V> HashMultimap<K, V> createFrom(final Iterable<V> iterable, final Function<? super V, K> keyFunction) {
     ...
     * @throws IllegalArgumentException when any of the given parameters are {@code null}
     */
    public static <E, K, V> HashMultimap<K, V> createFrom(final Iterable<E> iterable,
     ...
     * @throws IllegalArgumentException when any of the given parameters are {@code null}
     */
    public static <K, V> HashMultimap<K, V> createFrom(final Iterable<V> iterable,
