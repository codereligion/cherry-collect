...
public final class HashMaps {
     ...
     */
    public static <K, V> HashMap<K, V> from(final Iterable<V> iterable, final Function<? super V, K> keyFunction) {
     ...
     * @throws IllegalArgumentException when any of the given parameters are {@code null}
     */
    public static <E, K, V> HashMap<K, V> from(final Iterable<E> iterable,
     ...
     * @throws IllegalArgumentException when any of the given parameters are {@code null}
     */
    public static <K, V> HashMap<K, V> from(final Iterable<V> iterable, final Predicate<? super V> predicate, final Function<? super V, K> keyFunction) {
